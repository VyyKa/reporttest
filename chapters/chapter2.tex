...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{\detokenize{images/systemflow.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{\detokenize{images/Admin Main Flow.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{\detokenize{images/User Main Flow.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{\detokenize{images/User Space.pdf}}
\caption{User space data flow across management, security monitoring, and AI analysis components}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{\detokenize{images/User Use Case.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{\detokenize{images/Blueteamflow.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{\detokenize{images/Dashboardcomponents.pdf}}
...
\begin{longtable}{|>{\raggedright\arraybackslash}p{2.6cm}|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{5.4cm}|}
	\hline
...
\renewcommand{\arraystretch}{1.2}
\begin{longtable}{|c|>{\raggedright\arraybackslash}p{3.0cm}|>{\raggedright\arraybackslash}p{3.0cm}|>{\raggedright\arraybackslash}p{2.2cm}|>{\raggedright\arraybackslash}p{5.0cm}|}
	\hline
	...
	\hline
	04 & Docker & Containerization & 24.x & Provides consistent runtime environments for application and middleware components. Docker simplifies packaging, deployment repeatability, dependency isolation, and rapid rollback when validating attack-defense workflows. \\
	\hline
	...
	\hline
	11 & Groq API & LLM Inference API & API-based & Provides low-latency inference for natural-language analysis of correlated events. In this project, Groq-backed models are used to generate attack interpretation, investigation hints, and mitigation-oriented explanations suitable for trainee comprehension. \\
	\hline
	...
	\hline
	20 & Damn Vulnerable Web Application (DVWA) & Vulnerable Web Application & Latest & Deliberately vulnerable PHP/MySQL application used to simulate foundational web exploitation scenarios such as SQL Injection, XSS, and CSRF. DVWA supports controlled training with predictable behavior for educational repeatability. \\
	\hline
	21 & OWASP Juice Shop & Vulnerable Web Application & Latest & Modern intentionally vulnerable web application aligned with OWASP Top 10 categories. Juice Shop enables realistic testing of attack techniques, detection coverage, and AI-assisted explanation quality in more contemporary web stacks. \\
	\hline
...
\renewcommand{\arraystretch}{1.1}
\small
\begin{longtable}{|>{\raggedright\arraybackslash}p{3.3cm}|>{\raggedright\arraybackslash}p{2.6cm}|>{\raggedright\arraybackslash}p{2.0cm}|>{\raggedright\arraybackslash}p{1.8cm}|>{\raggedright\arraybackslash}p{4.8cm}|}
