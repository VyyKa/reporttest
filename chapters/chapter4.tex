...
\begin{longtable}{|p{0.06\textwidth}|p{0.41\textwidth}|p{0.41\textwidth}|}
    \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth,page=1]{images/rendered/serverrequirement.png}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|X|X|}
        ...
        \hline
        API authentication, RBAC, and rate limiting baseline & Completed & Nguyễn Văn Nhân \\
        \hline
        Injection payload validation test suite & Completed & Nguyễn Văn Nhân \\
        \hline
        Reverse proxy hardening and mirror verification checklist & Completed & Nguyễn Văn Nhân \\
        \hline
        Queue autoscaling and retry policy rollout & Completed & Trương Mỹ Vy \\
        \hline
        Prompt-safety and hallucination evaluation workflow & Completed & Hồ Tài Liên Vy Kha \\
        \hline
        AI-backend integration checkpoints for analysis pipeline & Completed & Huỳnh Ngọc Quang \\
        \hline
        PostgreSQL backup and restore validation cycle & Completed & Hồ Tài Liên Vy Kha \\
        \hline
        Redis logging integrity and tamper detection controls & Completed & Hồ Tài Liên Vy Kha \\
        \hline
        Centralized monitoring dashboard and alert tuning & Completed & Hồ Tài Liên Vy Kha \\
        \hline
        Proxmox segmentation policy verification & Completed & Huỳnh Ngọc Quang \\
        \hline
        Weekly risk report and mitigation progress documentation & Completed & Hồ Tài Liên Vy Kha \\
        \hline
    \end{tabularx}
