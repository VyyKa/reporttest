...
A comprehensive risk assessment helps the development team address system weaknesses before deployment and keep the training environment safe for experimentation.
...
The backend is implemented as a RESTful API using FastAPI and serves as the central control component for the platform.
...
The AI analysis layer helps interpret patterns such as SQL injection attempts, directory traversal attacks, and authentication bypass attempts.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{images/figure 3-1.png}}
    \caption{Proxmox host preparation for cyber range deployment}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/rendered/figure 3-2.png}
