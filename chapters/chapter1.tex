...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|l|c|>{\raggedright\arraybackslash}X|c|}
		...
		\hline
		01 & Mai Hoàng Đỉnh & 0933459100 & \url{Dinhmh@fe.edu.vn} & Supervisor \\
		\hline
	\end{tabularx}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/figure 1-1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/figure 1-2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/rendered/figure 1-3.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/figure\space\space 1-4.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/rendered/Dashboard.png}
